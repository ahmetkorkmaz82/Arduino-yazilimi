...
float degree = 90;
float pi = 3.14159;
float wheel_dia =  34; //66.25;   // mm (increase = spiral out)
int wheel_base = 95;    // mm (increase = spiral in) 
...
//
  ...
  byte lft[8] = {0x1F, 0x1F, 0x18, 0x99, 0xDB, 0x7E, 0x3C, 0x18};
  byte rgt[8] = {0x18, 0x3C, 0x7E, 0xDB, 0x99, 0x18, 0x18, 0x1F};
